...
///
/// The Gestion Employée entry (a dropdown of four sub-pages) lands in Phase 2
/// of the rebuild — see `.claude/phase_gestion_employee.md`. Phase 1 removed
/// the old Équipe + Personnel entries, so the rail is a flat list of direct
/// destinations again.
class AppSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < _destinations.length; i++) {
      if (location.contains('/${_destinations[i].matchSegment}')) {
        selectedIndex = i;
        break;
      }
    }
    ...
    return SizedBox(
      ...
      child: NavigationRail(
        // Nine destinations at 48dp plus the header no longer fit the 600dp
