...
class TeamMemberRow extends DataClass implements Insertable<TeamMemberRow> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, fullName, email, role, isActive, invitedAt, lastActiveAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $TeamMemberStoresTable extends TeamMemberStores
    with TableInfo<$TeamMemberStoresTable, TeamMemberStoreRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TeamMemberStoresTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [memberId, storeId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'team_member_stores';
  @override
  VerificationContext validateIntegrity(
    Insertable<TeamMemberStoreRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {memberId, storeId};
  @override
  TeamMemberStoreRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TeamMemberStoreRow(
  ...
  @override
  $TeamMemberStoresTable createAlias(String alias) {
    return $TeamMemberStoresTable(attachedDatabase, alias);
  }
}

class TeamMemberStoreRow extends DataClass
    implements Insertable<TeamMemberStoreRow> {
  final String memberId;
  final String storeId;
  const TeamMemberStoreRow({required this.memberId, required this.storeId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  TeamMemberStoresCompanion toCompanion(bool nullToAbsent) {
    return TeamMemberStoresCompanion(
      memberId: Value(memberId),
      storeId: Value(storeId),
    );
  }

  factory TeamMemberStoreRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TeamMemberStoreRow copyWith({String? memberId, String? storeId}) =>
      TeamMemberStoreRow(
        memberId: memberId ?? this.memberId,
        storeId: storeId ?? this.storeId,
      );
  TeamMemberStoreRow copyWithCompanion(TeamMemberStoresCompanion data) {
    return TeamMemberStoreRow(
  ...
  @override
  String toString() {
    return (StringBuffer('TeamMemberStoreRow(')
  ...
  @override
  int get hashCode => Object.hash(memberId, storeId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TeamMemberStoreRow &&
          other.memberId == this.memberId &&
          other.storeId == this.storeId);
}

class TeamMemberStoresCompanion extends UpdateCompanion<TeamMemberStoreRow> {
  final Value<String> memberId;
  final Value<String> storeId;
  final Value<int> rowid;
  const TeamMemberStoresCompanion({
    this.memberId = const Value.absent(),
    this.storeId = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  TeamMemberStoresCompanion.insert({
    required String memberId,
    required String storeId,
    this.rowid = const Value.absent(),
  }) : memberId = Value(memberId),
       storeId = Value(storeId);
  static Insertable<TeamMemberStoreRow> custom({
  ...
  TeamMemberStoresCompanion copyWith({
  ...
  @override
  String toString() {
    return (StringBuffer('TeamMemberStoresCompanion(')
          ..write('memberId: $memberId, ')
          ..write('storeId: $storeId, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $TeamMemberStoresTable teamMemberStores = $TeamMemberStoresTable(
    this,
  );
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('team_member_stores', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'stores',
