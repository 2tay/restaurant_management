/// Barrel export for the mock dataset.
///
/// Everything static the UI displays lives under `mock_data/` and nowhere else.
/// If a widget contains a hardcoded list of items, suppliers or figures, that
/// is a bug — move it here.
library;
...
export 'mock_payroll_periods.dart';
...
export 'mock_store_settings.dart';
...
export 'mutations/payroll_mutations.dart';
